          ...
          function h(l, s, d, f) {
            ...
            return (
                ...
                return (
                  ...
                  r.goTo(o).then(function () {
                    if (r.controllable && y.terrain_data[n.x][n.y] == t.STAIR) {
                      ...
                      var e = (0, i.generateLevel)(
                        y.engine,
                        y.depth + 1,
                        y.players.map(function (e) {
              ...
              (y.spawnCharacter = function (e) {
                ...
                switch (e.alignment) {
                  case c.PLAYER:
                    t = new r.Player(n, e.class, e.exp);
                    break;
                  case c.ENEMY:
                    t = new r.Enemy(n, e.class, e.exp);
                }
                return (
                  t.controllable
      ...
      function (require, module, exports) {
        ...
        function s(e, r, o) {
          ...
          return (
            ...
            new a.Level(e, l.asCell2dArray(), i, r)
          );
        }
...
//# sourceMappingURL=src.33dce08d.js.map

...
})(
  {
                      ...
                      for (var a = 0, c = s.length; a < c; a++)
                        (i = s[a]),
                          this._dynamicCollisionTree.query(
                            ...
                            function (t) {
                              if (
                                r._shouldGenerateCollisionPair(i, t.collider)
                              ) {
    ...
    x5mp: [
      function (require, module, exports) {
        ...
        var e = require("excalibur"),
          r = v(require("./images/sword_idle.png")),
          u = v(require("./images/sword_walk.png")),
          a = v(require("./images/sword_atk.png")),
          t = v(require("./images/bow_idle.png")),
          i = v(require("./images/bow_walk.png")),
          n = v(require("./images/bow_atk.png")),
          g = v(require("./images/magic_idle.png")),
          l = v(require("./images/magic_walk.png")),
          d = v(require("./images/magic_atk.png")),
          s = v(require("./images/enemysword_idle.png")),
          w = v(require("./images/enemysword_walk.png")),
          m = v(require("./images/enemysword_atk.png")),
          o = v(require("./images/enemybow_idle.png")),
          x = v(require("./images/enemybow_walk.png")),
          p = v(require("./images/enemybow_atk.png")),
          T = v(require("./images/enemymagic_idle.png")),
          f = v(require("./images/enemymagic_walk.png")),
          k = v(require("./images/enemymagic_atk.png")),
          q = v(require("./images/dungeontiles_1.png")),
          _ = v(require("./images/endturn.png")),
          c = v(require("./images/skip.png")),
          y = v(require("./images/title.png")),
          M = v(require("./images/gameover.png"));
        function v(e) {
          return e && e.__esModule ? e : { default: e };
        }
        var E = { title: new e.Texture(y.default) };
        exports.MainMenuResources = E;
        var b = { end: new e.Texture(M.default) };
        exports.GameOverResources = b;
        var S = {
          ...
          BowWalk: new e.Texture(i.default),
          BowAtk: new e.Texture(n.default),
          ...
          SkipTutorialTexture: new e.Texture(c.default),
        };
        exports.Resources = S;
      },
      {
      ...
      function (require, module, exports) {
        ...
        var i = (function (r) {
          function i(a) {
            ...
            return (
              (i.moveRange = { inner: 3, outer: 3 }),
              (i.defence = { magic: 2, physical: 10 }),
              (i.attack = { range: 1, magicalDamage: 0, physicalDamage: 12 }),
              (i.health = { maxHealth: 40, healOnNoMove: 10 }),
              a
                ? ((i.idleSheet = new e.SpriteSheet(
          ...
          return (
            a(i, r),
            (i.prototype.levelUp = function (e) {
              void 0 === e && (e = 1);
              for (var t = 0; t < e; t++)
                this.level % 5 == 0 &&
            ...
            (i.prototype.expForNextLevel = function () {
              return 5 * this.level;
            }),
            (i.prototype.deathExp = function () {
              return 5 * this.level;
            }),
            i
          );
        ...
        var o = (function (r) {
          function i(a) {
            var i = r.call(this) || this;
            return (
              (i.moveRange = { inner: 4, outer: 4 }),
              (i.defence = { magic: 2, physical: 2 }),
              (i.attack = { range: 4, magicalDamage: 0, physicalDamage: 20 }),
              (i.health = { maxHealth: 30, healOnNoMove: 15 }),
              a
                ? ((i.idleSheet = new e.SpriteSheet(
                    t.Resources.BowIdle,
                    4,
        ...
        var n = (function (r) {
          function i(a) {
            var i = r.call(this) || this;
            return (
              (i.moveRange = { inner: 2, outer: 2 }),
              (i.defence = { magic: 10, physical: 2 }),
              (i.attack = { range: 5, magicalDamage: 20, physicalDamage: 0 }),
              (i.health = { maxHealth: 30, healOnNoMove: 10 }),
              a
                ? ((i.idleSheet = new e.SpriteSheet(
    ...
    pDJl: [
      function (require, module, exports) {
        ...
        var d = (function (a) {
          function d(s, u, v, y, f) {
            var T = a.call(this, s) || this;
            return (
              (T.enemies = []),
              (T.players = []),
              (T.moveOverlay = []),
              ...
              (T.launchTutorial = function () {
                ...
                var n = T.enemies.slice().sort(function (e, n) {
                  return h(e.pos, t) - h(e.pos, t);
                })[0].pos;
              ...
              (T.generateTextOverlay = function (t, n) {
                var r = (d.TILE_SIZE * t.length) / 2 + 5,
              ...
              (T.moveCharacter = function (e, t, n) {
                console.log("moving character " + n.id);
                var r = T.pathfind(e, t).map(T.tileToPixelCoords);
                return (
                  (T.map_data[e.x][e.y].character = void 0),
                  (T.map_data[t.x][t.y].character = n),
                  n.goTo(r).then(function () {
                    if (n.controllable && T.terrain_data[t.x][t.y] == l.STAIR) {
              ...
              (T.spawnCharacter = function (e) {
                var n,
                  r,
                  o = T.tileToPixelCoords(e.spawnTile);
                switch (e.alignment) {
                  case c.PLAYER:
                    n = new t.Player(o, e.class, e.exp);
                    break;
                  case c.ENEMY:
                    n = new t.Enemy(o, e.class, e.exp);
                }
                return (
                  n.controllable
                    ? (n.on("pointerup", function () {
                        T.selectedPlayer && T.selectedPlayer.id == n.id
                          ? T.deselectPlayer()
                          : (T.selectedPlayer && T.deselectPlayer(),
                            T.selectPlayer(n),
                            T.statOverlay && T.createStatOverlay(n));
                      }),
                      T.players.push(n))
                    : T.enemies.push(n),
                  (n.onPostUpdate = function () {
                    !r &&
                      T.engine.input.pointers.primary.checkActorUnderPointer(
                        n
                      ) &&
                      (T.createStatOverlay(n), (r = T.statOverlay)),
                      r &&
                        !T.engine.input.pointers.primary.checkActorUnderPointer(
                          n
                        ) &&
                  ...
                  (T.map_data[e.spawnTile.x][e.spawnTile.y].character = n),
                  n
                );
              }),
              (T.selectPlayer = function (e) {
                T.generateOverlay(e), (T.selectedPlayer = e);
              }),
              (T.getPossibleMoves = function (e, t) {
                var n = T.pixelToTileCoords(e.pos),
                ...
                e.moveExhausted.inner ||
                  (i = T.getTilesWithinDist(n, e.cClass.moveRange.inner)),
                  e.moveExhausted.outer || i.push(n);
                var a = [];
                return (
              ...
              (T.attack = function (t, n) {
                if (
                  (t.setDrawing("atk"),
                  (t.currentDrawing.flipHorizontal = n.pos.x < t.pos.x),
                  setTimeout(function () {
                    t.setDrawing("idle");
                  }, 1e3),
                  n.damage(t.cClass.attack))
                ) {
                  var r = t.gainExp(n.cClass.deathExp());
                  if (r) {
                  ...
                  var i = T.pixelToTileCoords(n.pos);
                ...
                t.spendAttack(),
                  console.log(
                    t.id +
                      ...
                      n.id +
                      " at " +
                      T.pixelToTileCoords(n.pos) +
                      ", its health is now " +
                      n.health
                  );
              }),
              (T.moveToThenAttack = function (e, t, n, r) {
                var o = T.pixelToTileCoords(e.pos),
                  i = T.getAttackStagingPoint(o, n, e, r);
                return T.moveCharacter(o, i, e).then(function () {
                  return T.attack(e, t);
                });
              }),
              (T.generateOverlay = function (t) {
                var n = T.getPossibleMoves(t, T.enemies);
                (T.moveOverlay = n.allMoves.map(function (r) {
                  var o,
                    i = T.tileToPixelCoords(r),
                    a = new e.Actor({
                      x: i.x + 2,
                      y: i.y + 2,
                      width: d.TILE_SIZE - 4,
                  ...
                  return (
                    a.on("pointerdown", function (t) {
                      if (
                        ...
                        var n = T.pixelToTileCoords(T.selectedPlayer.pos);
                        T.moveCharacter(n, r, T.selectedPlayer),
                          T.deselectPlayer();
                      }
                    }),
                    (a.onPostDraw = function (n, o) {
                      if (
                  ...
                  (T.attackOverlay = n.attackableEnemies.map(function (r) {
                    var o = r.enemy,
                      i = r.enemyPos,
              ...
              (T.getTilesWithinDist = function (t, n) {
                if (n <= 0) return [];
                var r = new Array(),
                  o = new Array(),
                  i = [
                ...
                for (
                  var a = function () {
                    ...
                    i.map(function (t) {
                      ...
                      .filter(function (e) {
                        return (
                          !p[T.terrain_data[e.x][e.y]].solid &&
              ...
              (T.enemyTurn = function () {
                var e = 0,
                  t = T.enemies.slice().filter(function (e) {
                    return T.players.some(function (t) {
                      return h(t.pos, e.pos) < 10 * d.TILE_SIZE;
                    });
                  });
                ...
                !(function n() {
                  console.log("moving enemy #" + (e + 1)),
                    e < t.length
                      ? (T.calculateEnemyMove(t[e]).then(n), e++)
                      : T.nextTurn();
                })();
              }),
              (T.calculateEnemyMove = function (e) {
                var t = T.pixelToTileCoords(e.pos),
                  n = T.getPossibleMoves(e, T.players),
                  r = n.innerMoves,
                  o = n.allMoves,
                  a = n.attackableEnemies;
                if (a.length > 0) {
                  var l = a.sort(function (e, n) {
                    return h(e.enemyPos, t) - h(n.enemyPos, t);
                  })[0];
                  return T.moveToThenAttack(e, l.enemy, l.enemyPos, r);
                }
                var s = T.players.map(function (e) {
                  return { player: e, playerPos: T.pixelToTileCoords(e.pos) };
                });
                s.sort(function (e, n) {
                  return h(e.playerPos, t) - h(n.playerPos, t);
                });
                for (
                  var u = function (n) {
                      o.sort(function (e, t) {
                        return h(e, n.playerPos) - h(t, n.playerPos);
                      });
                      var r = T.pathfind(t, o[0])[
                        e.cClass.moveRange.inner + e.cClass.moveRange.outer
                      ];
                      if (r) return { value: T.moveCharacter(t, r, e) };
                    },
                    c = 0,
                    p = s;
                  c < p.length;
              ...
              (T.level_depth_label.text = "Depth: " + y),
              (T.stairLocation = f),
              (s.backgroundColor = e.Color.Black),
              (T.terrain_data = u),
              ...
              (T.tilesheet = new e.SpriteSheet({
                image: r.Resources.TileTexture,
                spWidth: d.TILE_SIZE,
                spHeight: d.TILE_SIZE,
                rows: r.Resources.TileTexture.height / d.TILE_SIZE,
                columns: r.Resources.TileTexture.width / d.TILE_SIZE,
              })),
              T.tilemap.registerSpriteSheet("tile", T.tilesheet),
              v.forEach(T.spawnCharacter),
              (T.engine = s),
              (T.path_finder = new n.AStarFinder()),
              (T.playerTurn = !0),
              T
            );
          }
          return (
            s(d, a),
            (d.prototype.showTutorialOverlay = function (t, n, r, o) {
              var i, a;
              void 0 === o && (o = !0),
                ...
                this.tutorialOverlay.on("pointerdown", r),
                this.add(this.tutorialOverlay),
                o && (this.camera.pos = n.clone());
            }),
            (d.prototype.createSkipTutorialButton = function () {
              ...
              this.skipTutorialButton = new e.ScreenElement({
                ...
                width: r.Resources.SkipTutorialTexture.width,
                height: 30,
              });
              var n = new e.SpriteSheet(
                r.Resources.SkipTutorialTexture,
                1,
                2,
                r.Resources.SkipTutorialTexture.width,
                30
              );
              return (
                this.skipTutorialButton.addDrawing("normal", n.getSprite(0)),
                this.skipTutorialButton.addDrawing("hovered", n.getSprite(1)),
            ...
            (d.prototype.onInitialize = function (t) {
              ...
              this.nextTurnButton.addDrawing("normal", i.getSprite(0)),
                ...
                this.engine.input.keyboard.on("press", function (t) {
                  switch (t.key) {
                    case e.Input.Keys.A:
                      n.camera.vel.x = -d.CAMERA_SPEED;
                      break;
                    case e.Input.Keys.D:
                      n.camera.vel.x = d.CAMERA_SPEED;
                      break;
                    case e.Input.Keys.W:
                      n.camera.vel.y = -d.CAMERA_SPEED;
                      break;
                    case e.Input.Keys.S:
                      n.camera.vel.y = d.CAMERA_SPEED;
                  }
            ...
            (d.prototype.syncTerrainData = function () {
              var t = this;
              this.tilemap.data.forEach(function (n, r) {
                n.clearSprites();
                var o = Math.floor(r / t.tilemap.cols),
                  i = r % t.tilemap.cols;
                switch (t.terrain_data[i][o]) {
                  case l.WALL:
                    n.solid = p[l.WALL].solid;
                    var a = 0;
                    t.terrain_data[i][o + 1] &&
                      t.terrain_data[i][o + 1] == l.FLOOR &&
                      (a = 1),
                      n.pushSprite(new e.TileSprite("tile", a));
                    break;
                  case l.FLOOR:
                    (n.solid = p[l.FLOOR].solid),
                      n.pushSprite(new e.TileSprite("tile", 2));
                    break;
                  case l.STAIR:
                    (n.solid = p[l.STAIR].solid),
                      n.pushSprite(new e.TileSprite("tile", 3));
                    break;
                  case l.NONE:
                    (n.solid = p[l.NONE].solid),
                      n.pushSprite(new e.TileSprite("tile", 0));
                }
              });
            }),
            ...
            (d.prototype.pathfind = function (t, r) {
              ...
              return this.path_finder
                .findPath(t.x, t.y, r.x, r.y, new n.Grid(o))
                .map(function (t) {
            ...
            (d.prototype.pixelToTileCoords = function (t) {
              var n = t
                .sub(e.Vector.One.scale(d.TILE_SIZE / 2))
                .scale(1 / d.TILE_SIZE)
                .add((0, e.vec)(this.tilemap.x, this.tilemap.y));
              return (0, e.vec)(Math.floor(n.x), Math.floor(n.y));
            }),
            (d.prototype.gameOver = function () {
              var t = this,
                n = new e.Loader();
              for (var i in r.GameOverResources)
                n.addResource(r.GameOverResources[i]);
              (n.suppressPlayButton = !0),
                (n.logo = ""),
                (n.backgroundColor = "black");
              var a = new e.Actor({ x: 360, y: 240, width: 720, height: 480 });
              a.addDrawing("title", r.GameOverResources.end.asSprite()),
                a.on("pointerdown", function () {
                  a.off("pointerdown"),
                    t.engine.add("level_1", (0, o.generateLevel)(t.engine, 1)),
                    t.engine.goToScene("level_1");
                });
              var l = new e.Label("Click Anywhere to Try Again");
              (l.fontSize = 20),
                (l.fontFamily = "serif"),
                (l.color = e.Color.White),
                (l.pos = (0, e.vec)(
                  360 - l.getTextWidth(this.engine.ctx) / 2,
                  450
                )),
                l.actions.blink(500, 500).repeatForever();
              var s = new e.Scene(this.engine);
              s.add(a),
                s.add(l),
                this.engine.start(n).then(function () {
                  t.goToLevel(s);
                });
            }),
            (d.prototype.getAttackStagingPoint = function (e, t, n, r) {
              var o = e;
              return (
                h(t, e) != n.cClass.attack.range &&
                  (o = r
                    .filter(function (e) {
                      return h(e, t) <= n.cClass.attack.range;
                    })
                    .sort(function (t, n) {
                      return h(t, e) - h(n, e);
                    })
    ...
    B6dB: [
      function (require, module, exports) {
        ...
        function s(e, r, o) {
          var l = new n.Dungeon(1),
            i = [];
          if (o) {
            var s = l.getPlayerSpawnPoints(o.length);
            o.forEach(function (e, n) {
              i.push({
                alignment: a.CharacterAlignment.PLAYER,
                class: e.class,
                spawnTile: s[n],
                exp: e.exp,
              });
            ...
            var c = l.getPlayerSpawnPoints(3);
            i.push({
              alignment: a.CharacterAlignment.PLAYER,
              class: new t.Bow(!0),
              spawnTile: c[0],
          ...
          var u = l.getEnemySpawnPoints(1, 2, 3),
            d = 2 * (r - 1);
          return (
            u.forEach(function (e) {
              var r = [
                new t.Sword(!1).levelUp(d + (0, n.getRandomInt)(0, 1)),
                new t.Sword(!1).levelUp(d),
                new t.Bow(!1).levelUp(d + (0, n.getRandomInt)(0, 1)),
                new t.Bow(!1).levelUp(d),
                new t.Magic(!1).levelUp(d + (0, n.getRandomInt)(0, 1)),
                new t.Magic(!1).levelUp(d),
              ];
              e.forEach(function (e) {
                return i.push({
                  alignment: a.CharacterAlignment.ENEMY,
                  class: r.splice((0, n.getRandomInt)(0, r.length - 1), 1)[0],
                  spawnTile: e,
                });
              });
            }),
            new a.Level(e, l.asCell2dArray(), i, r, l.getstairLocation())
          );
        }
        ...
        w.add(u),
          ...
          o.start(c).then(function () {
            o.add("main_menu", w), o.goToScene("main_menu");
          });
      },
      {
        excalibur: "jZN7",
...
//# sourceMappingURL=src.b23c994f.js.map

    ...
    x5mp: [
      function (require, module, exports) {
        ...
        var e = require("excalibur"),
          ...
          i = M(require("./images/sword_atk.png")),
          a = M(require("./images/bow_idle.png")),
          n = M(require("./images/bow_walk.png")),
          t = M(require("./images/bow_atk.png")),
          s = M(require("./images/magic_idle.png")),
          w = M(require("./images/magic_walk.png")),
          d = M(require("./images/magic_atk.png")),
          l = M(require("./images/enemysword_idle.png")),
          o = M(require("./images/enemysword_walk.png")),
          g = M(require("./images/enemysword_atk.png")),
          m = M(require("./images/enemybow_idle.png")),
          c = M(require("./images/enemybow_walk.png")),
          x = M(require("./images/enemybow_atk.png")),
          p = M(require("./images/enemymagic_idle.png")),
          q = M(require("./images/enemymagic_walk.png")),
          T = M(require("./images/enemymagic_atk.png")),
          k = M(require("./images/dungeontiles_1.png")),
          f = M(require("./images/endturn.png")),
          _ = M(require("./images/skip.png")),
          v = M(require("./images/title.png")),
          y = M(require("./images/gameover.png")),
          S = M(require("./images/cursor.png"));
        function M(e) {
          return e && e.__esModule ? e : { default: e };
        }
        var b = { title: new e.Texture(v.default) };
        exports.MainMenuResources = b;
        ...
        var d = (function (a) {
          function d(s, u, v, y, f) {
            ...
            return (
              ...
              (T.moveCharacter = function (e, t, r) {
                ...
                return (
                  ...
                  r.goTo(n).then(function () {
                    if (r.controllable && T.terrain_data[t.x][t.y] == l.STAIR) {
              ...
              (T.calculateEnemyMove = function (e) {
                ...
                if (a.length > 0) {
                  var l = a.sort(function (e, r) {
                    return h(e.enemyPos, t) - h(r.enemyPos, t);
                  })[0];
                  return T.moveToThenAttack(e, l.enemy, l.enemyPos, n);
                }
                var s = T.players.map(function (e) {
                  return { player: e, playerPos: T.pixelToTileCoords(e.pos) };
                });
                s.sort(function (e, r) {
                  return h(e.playerPos, t) - h(r.playerPos, t);
                });
                for (
                  var u = function (r) {
                      if (
                        (o.sort(function (e, t) {
                          return h(e, r.playerPos) - h(t, r.playerPos);
                        }),
                        o[0])
                      ) {
          ...
          return (
            ...
            (d.prototype.getAttackStagingPoint = function (e, t, r, n) {
              var o = e;
              return (
                h(t, e) != r.cClass.attack.range &&
                  (o = n
                    .filter(function (e) {
                      return h(e, t) <= r.cClass.attack.range;
                    })
                    .sort(function (t, r) {
                      return h(t, e) - h(r, e);
                    })
...
//# sourceMappingURL=src.cc0153be.js.map

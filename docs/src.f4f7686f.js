      ...
      function (require, module, exports) {
        ...
        var o = (function (r) {
          function o(a) {
            ...
            return (
              ...
              (o.attack = { range: 1, magicalDamage: 0, physicalDamage: 15 }),
          ...
          return (
            ...
            (o.prototype.playAttackSound = function () {
              t.MusicResources.Sword.play(0.5);
            }),
            o
          );
        })(r);
        ...
        var i = (function (r) {
          ...
          return (
            ...
            (o.prototype.playAttackSound = function () {
              t.MusicResources.Magic.play(0.5);
            }),
            o
          );
        })(r);
          ...
          function d(l, u, y, v, f) {
            ...
            return (
                  ...
                  r.controllable
                    ? (r.on("pointerup", function () {
                        T.selectedPlayer && T.selectedPlayer.id == r.id
                          ? (T.deselectPlayer(),
                            n.MusicResources.Deselect.play(0.5))
              ...
              (T.selectPlayer = function (e) {
                n.MusicResources.Select.play(0.5),
                  T.generateOverlay(e),
                  (T.selectedPlayer = e);
              }),
              ...
              (T.enemyTurn = function () {
                var e,
                  t = 0,
                  r = T.enemies.slice().filter(function (e) {
                    return T.players.some(function (t) {
                      return p(t.pos, e.pos) < 10 * d.TILE_SIZE;
                    });
                  });
                console.log("moving " + r.length + " this turn");
                null === (e = T.enemyPhaseIndicator) ||
                  void 0 === e ||
                  e.actions
                    .fade(1, 500)
                    .fade(0.001, 500)
                    ...
                    .then(function () {
                      !(function e() {
                        console.log("moving enemy #" + (t + 1)),
                          t < r.length
                            ? (T.calculateEnemyMove(r[t]).then(e), t++)
                            : T.nextTurn();
                      })();
                    });
              }),
            ...
            (d.prototype.onInitialize = function (t) {
              ...
              this.nextTurnButton.addDrawing("normal", i.getSprite(0)),
                ...
                n.MusicResources.DarkHollows.isPlaying() ||
                  ...
                  n.MusicResources.DarkHollows.play(0.5)),
      ...
      function (require, module, exports) {
        ...
        var e = require("excalibur"),
          ...
          o = new e.Engine({
            ...
            displayMode: e.DisplayMode.Fixed,
          }),
          l = new e.Loader();
        ...
        function s(e, r, o) {
          ...
          if (o) {
            ...
            i.push({
              alignment: a.CharacterAlignment.PLAYER,
              class: new t.Bow(!0).levelUp(),
              spawnTile: c[0],
            }),
              i.push({
                alignment: a.CharacterAlignment.PLAYER,
                class: new t.Sword(!0).levelUp(),
                spawnTile: c[1],
              }),
              i.push({
                alignment: a.CharacterAlignment.PLAYER,
                class: new t.Magic(!0).levelUp(),
                spawnTile: c[2],
              });
          }
        ...
        p.add(u),
          ...
          (p.onInitialize = function () {
            r.MusicResources.Title.play(0.5);
          }),
...
//# sourceMappingURL=src.f4f7686f.js.map

parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    A0GD: [
      function (require, module, exports) {
        module.exports = "darkhollows.dc5ba040.mp3";
      },
      {},
    ],
    gpIJ: [
    ...
    x5mp: [
      function (require, module, exports) {
        ...
        var e = require("excalibur"),
          r = S(require("./images/sword_idle.png")),
          u = S(require("./images/sword_walk.png")),
          i = S(require("./images/sword_atk.png")),
          a = S(require("./images/bow_idle.png")),
          n = S(require("./images/bow_walk.png")),
          t = S(require("./images/bow_atk.png")),
          s = S(require("./images/magic_idle.png")),
          w = S(require("./images/magic_walk.png")),
          d = S(require("./images/magic_atk.png")),
          l = S(require("./images/enemysword_idle.png")),
          o = S(require("./images/enemysword_walk.png")),
          g = S(require("./images/enemysword_atk.png")),
          m = S(require("./images/enemybow_idle.png")),
          c = S(require("./images/enemybow_walk.png")),
          x = S(require("./images/enemybow_atk.png")),
          p = S(require("./images/enemymagic_idle.png")),
          q = S(require("./images/enemymagic_walk.png")),
          T = S(require("./images/enemymagic_atk.png")),
          k = S(require("./images/dungeontiles_1.png")),
          f = S(require("./images/endturn.png")),
          _ = S(require("./images/skip.png")),
          y = S(require("./images/title.png")),
          v = S(require("./images/gameover.png"));
        function S(e) {
          return e && e.__esModule ? e : { default: e };
        }
        var M = { title: new e.Texture(y.default) };
        exports.MainMenuResources = M;
        var b = { end: new e.Texture(v.default) };
        exports.GameOverResources = b;
        var E = {
          SwordIdle: new e.Texture(r.default),
          SwordWalk: new e.Texture(u.default),
          SwordAtk: new e.Texture(i.default),
          BowIdle: new e.Texture(a.default),
          ...
          EnemySwordIdle: new e.Texture(l.default),
          EnemySwordWalk: new e.Texture(o.default),
          EnemySwordAtk: new e.Texture(g.default),
          EnemyBowIdle: new e.Texture(m.default),
          EnemyBowWalk: new e.Texture(c.default),
          EnemyBowAtk: new e.Texture(x.default),
          EnemyMagicIdle: new e.Texture(p.default),
          EnemyMagicWalk: new e.Texture(q.default),
          EnemyMagicAtk: new e.Texture(T.default),
          TileTexture: new e.Texture(k.default),
          NextTurnTexture: new e.Texture(f.default),
          SkipTutorialTexture: new e.Texture(_.default),
        };
        exports.Resources = E;
        var R = {
          ...
          DarkHollows: new e.Sound(require("./music/darkhollows.mp3")),
        ...
        var d = (function (a) {
          function d(s, u, v, y, f) {
            ...
            return (
              ...
              (T.spawnCharacter = function (e) {
                ...
                switch (e.alignment) {
                  case c.PLAYER:
                    n = new t.Player(i, e.class, e.exp);
                    break;
                  case c.ENEMY:
                    n = new t.Enemy(i, e.class, e.exp);
                }
                return (
                  n.controllable
                    ? (n.on("pointerup", function () {
                        T.selectedPlayer && T.selectedPlayer.id == n.id
                          ? (T.deselectPlayer(),
                            r.MusicResources.Deselect.play())
                  ...
                  (n.onPostUpdate = function () {
                    !o &&
                      ...
                      (T.createStatOverlay(n), (o = T.statOverlay)),
                      o &&
                        !T.engine.input.pointers.primary.checkActorUnderPointer(
                          n
                        ) &&
          ...
          return (
            ...
            (d.prototype.onInitialize = function (t) {
              var n = this,
                i = new e.ScreenElement({ x: 0, y: 0 });
              i.add(this.level_depth_label),
                t.add(i),
                t.add(this.tilemap),
              ...
              if (
                (this.nextTurnButton.addDrawing("normal", a.getSprite(0)),
                this.nextTurnButton.addDrawing("hovered", a.getSprite(1)),
                ...
                this.launchTutorial();
                var l = (0, o.generateLevel)(
                  this.engine,
                  this.depth + 1,
                  this.players.map(function (e) {
                    return { class: e.cClass, exp: e.exp };
                  })
                );
                this.goToLevel(l);
...
//# sourceMappingURL=src.0c2281a2.js.map
